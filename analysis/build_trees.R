...
# knitr chunk.
#
#   Rscript analysis/build_trees.R test_study
#   Rscript analysis/build_trees.R case_study2
#
...
# also preserves repdist_bin()'s all-pairs TM-score threshold guarantee.
#
...
# cosine distance, the same form seq_repdist() uses on embeddings
